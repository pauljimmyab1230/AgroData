    ...
    },
    {
      ...
      render: (inspeccion: Inspeccion) => (
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-medium text-[#111827]">{inspeccion.productorNombre}</p>
            <p className="text-xs text-gray-500">{inspeccion.cultivoNombre}</p>
          </div>
        </div>
      ),
    },
    { key: "parcelaNombre", label: "Parcela" },
