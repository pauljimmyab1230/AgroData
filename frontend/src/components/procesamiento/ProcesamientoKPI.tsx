...
export interface ProcesamientoKpiItem {
  label: string;
  value: string;
  icon: LucideIcon;
  iconClass: string;
...
interface ProcesamientoKPIProps {
  items: ProcesamientoKpiItem[];
}

export default function ProcesamientoKPI({ items }: ProcesamientoKPIProps) {
  return (
