      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center">
        ...
        <div className="flex-1">
          ...
          <p className="mt-1 text-sm text-gray-500">
            ...
            {" · "}Productor: <span className="font-medium text-[#111827]">{inspeccion.productor}</span>
            {" · "}Parcela: <span className="font-medium text-[#111827]">{inspeccion.parcela}</span>
          </p>
          <p className="mt-1 text-sm text-gray-500">
            Inspector: <span className="font-medium text-[#111827]">{inspeccion.inspector}</span>
            {" · "}Campaña: <span className="font-medium text-[#111827]">{inspeccion.campania}</span>
            {" · "}Cultivo: <span className="font-medium text-[#111827]">{inspeccion.cultivo}</span>
          </p>
        </div>
