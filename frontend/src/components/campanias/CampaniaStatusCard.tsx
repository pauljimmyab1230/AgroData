...
import { campaniaEstados, type CampaniaEstado, type CampaniaFormData } from "../../pages/campañas/campaniaMock";
...
const configuracionEstado: Record<CampaniaEstado, EstadoConfig> = {
  Planificada: {
    icon: CalendarClock,
