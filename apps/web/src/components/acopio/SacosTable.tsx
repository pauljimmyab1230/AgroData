...
import { formatKg } from "../../services/acopios";

type SacoItem = { id: number; codigo: string; peso: number; observaciones: string };
...
export default function SacosTable({ mode, sacos }: SacosTableProps) {
  ...
  const [items, setItems] = useState<SacoItem[]>(sacos ?? []);
